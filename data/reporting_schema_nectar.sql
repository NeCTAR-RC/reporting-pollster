...
create table if not exists hypervisor (
        ...
        key hypervisor_last_seen (last_seen)
...
create table if not exists allocation (
        ...
        chief_investigator varchar(75) comment 'The nominated chief investigator (if any)',
        status varchar(1) comment 'Status of the allocation request',
        start_date datetime comment 'The start of the allocation',
        end_date datetime comment 'The end of the allocation',
